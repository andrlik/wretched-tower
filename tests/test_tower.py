...
@pytest.mark.parametrize("dice_size,expected_dict", [
...
def test_tower_roll() -> None:
    ...
    assert tower.get_dice_left() == expected_dice - tower.roll_distributions[0].dice_results[1]
    ...
    assert tower.get_dice_left() == expected_dice - tower.roll_distributions[1].dice_results[1]
...
@pytest.mark.parametrize("dice_amount,expected_peril", [
